  ...
  return (
    <div className='fixed mt-8 space-y-11 md:inline-block hidden'>
      <div className="bg-dark-alt text-light flex w-14 flex-col items-center space-y-7 py-6 rounded-full shadow-inner">
        {/* Home  */}
        <Link to='/' className={location.pathname === '/' ? 'text-secondary' : 'text-dark'}>
        ...
        {/* COllection */}
        <Link to='/collection' className={location.pathname === '/collection' ? 'text-secondary' : 'text-dark'}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
        ...
        {/* Radio */}
        <Link to='/radio' className={location.pathname === '/radio' ? 'text-secondary' : 'text-dark'}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
        ...
        {/* Video  */}
        <Link to='/videos' className={location.pathname === '/videos' ? 'text-secondary' : 'text-dark'}>
      ...
      <div className="bg-dark-alt text-light flex w-14 flex-col items-center space-y-4 py-6 rounded-full shadow-inner">
        ...
        <Link to='/profile' className={location.pathname === '/profile' ? 'text-secondary' : 'text-dark'}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
