    ...
    >
      <nav className='flex items-center gap-x-20 py-3 px-6 md:px-10'>
        ...
        >
          ...
          <Link to='/collection' onClick={closeMenu} className='flex items-center gap-x-6 font-semibold tracking-wider text-lg hover:opacity-70'>
          ...
          <Link to='/radio' onClick={closeMenu} className='flex items-center gap-x-6 font-semibold tracking-wider text-lg hover:opacity-70'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
          ...
          <Link to='/videos' onClick={closeMenu} className='flex items-center gap-x-6 font-semibold tracking-wider text-lg hover:opacity-70'>
          ...
          <Link to='/profile' onClick={closeMenu} className='flex items-center gap-x-6 font-semibold tracking-wider text-lg hover:opacity-70'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
