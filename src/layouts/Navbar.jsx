...
function Navbar() {
  ...
  return (
    <div 
      // className='sticky top-0 z-10 bg-main'
    >
      <nav className='flex items-center gap-x-20 py-3 px-6 md:px-10'>
        ...
        {/* Mobile Screen  */}
        <ul
          className={`bg-dark-alt absolute top-0 w-full flex flex-col h-screen py-36 px-12 space-y-12 delay-200 duration-500 z-10 lg:hidden transition ${open ? 'left-0' : 'left-[-100%]'}`}
        >
          <NavLink to='/' onClick={closeMenu} className={`flex items-center gap-x-6 font-semibold tracking-wider text-lg hover:opacity-70`}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-8 h-8 ${({isActive}) => isActive ? active : notActive }`}>
          ...
          <NavLink to='/collection' onClick={closeMenu} className={`flex items-center gap-x-6 font-semibold tracking-wider text-lg hover:opacity-70 ${({isActive}) => isActive ? active : notActive }`}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-8 h-8 ${({isActive}) => isActive ? active : notActive }`}>
          ...
          <NavLink to='/radio' onClick={closeMenu} className={`flex items-center gap-x-6 font-semibold tracking-wider text-lg hover:opacity-70 ${({isActive}) => isActive ? active : notActive }`}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-8 h-8 ${({isActive}) => isActive ? active : notActive }`}>
          ...
          <NavLink to='/videos' onClick={closeMenu} className={`flex items-center gap-x-6 font-semibold tracking-wider text-lg hover:opacity-70 ${({isActive}) => isActive ? active : notActive }`}>
            <svg viewBox="0 0 24 24" fill="currentColor" className={`w-8 h-8 ${({isActive}) => isActive ? active : notActive }`}>
          ...
          <NavLink to='/profile' onClick={closeMenu} className={`flex items-center gap-x-6 font-semibold tracking-wider text-lg hover:opacity-70 ${({isActive}) => isActive ? active : notActive }`}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-8 h-8 ${({isActive}) => isActive ? active : notActive }`}>
              <path fillRule="evenodd" d="M7.5 6a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM3.751 20.105a8.25 8.25 0 0116.498 0 .75.75 0 01-.437.695A18.683 18.683 0 0112 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 01-.437-.695z" clipRule="evenodd" />
            </svg>
            Profile
          </NavLink>
          <li  onClick={closeMenu} className={`flex items-center gap-x-6 font-semibold tracking-wider text-lg hover:opacity-70 ${({isActive}) => isActive ? active : notActive }`}>
